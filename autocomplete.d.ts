...
interface DbAutocompleteSuggestion {
    value: string;
    data: any;
}

interface DbAutocompleteResponse {
    suggestions: DbAutocompleteSuggestion[];
}

interface DbAutocompleteOptions {
    // TODO: define private
    onHint?: any;
    ignoreParams?: any;
     ...
     * @param suggestions
     */
    onSearchComplete?(query: string, suggestions: DbAutocompleteSuggestion[]): void;
     ...
     * @param originalQuery
     */
    transformResult?(response: any, originalQuery: string): DbAutocompleteResponse;
     ...
     * @param suggestion
     */
    onSelect?(suggestion: DbAutocompleteSuggestion): void;
     ...
     */
    lookup?: (q: any, Function)=> void | DbAutocompleteSuggestion[];
     ...
     */
    lookupFilter?(suggestion: DbAutocompleteSuggestion, query: string, queryLowercase: string): any;
     ...
     * @param currentValue
     */
    formatResult?(suggestion: DbAutocompleteSuggestion, currentValue: string): string;
...
interface DbAutocompleteInstance {

    /**
     * you may update any option at any time. Options are listed above.
     * @param options
     */
    setOptions(options: DbAutocompleteOptions): void;
...
interface JQuery {
     ...
     */
    dbAutocomplete(options?: DbAutocompleteOptions): DbAutocompleteInstance;
     ...
     * @param arg
     */
    dbAutocomplete(methodName: string, ...arg: any[]): any;
     ...
     * @param options
     */
    dbAutocomplete(methodName: "setOptions", options: DbAutocompleteOptions): DbAutocompleteInstance;

    /**
     * Clears suggestion cache and current suggestions suggestions.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "clear"): DbAutocompleteInstance;

    /**
     * Clears suggestion cache.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "clearCache"): DbAutocompleteInstance;

    /**
     * Deactivate autocomplete.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "disable"): DbAutocompleteInstance;

    /**
     * Activates autocomplete if it was deactivated before.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "enable"): DbAutocompleteInstance;

    /**
     * Hides suggestions.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "hide"): DbAutocompleteInstance;

    /**
     * Destroys autocomplete instance. All events are detached and suggestion containers removed.
     * @param methodName The name of the method
     */
    dbAutocomplete(methodName: "dispose"): DbAutocompleteInstance;
